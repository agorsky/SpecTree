  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (err instanceof ApiError) {
        ...
        setError(data?.error?.message || `Error ${err.response.status}: Failed to delete project`);
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              delete all features and tasks in this project. This action cannot be undone.
            </DialogDescription>
          </DialogHeader>
