...
| `.github/skills/dispatcher-planning/SKILL.md` | 323 | 8 |
| `.github/skills/dispatcher-plan-review/SKILL.md` | 320 | 8 |
| `.github/skills/dispatcher-validation/SKILL.md` | 266 | 7 |
| `.github/skills/dispatcher-session/SKILL.md` | 254 | 8 |
...
- **`.github/copilot-instructions.md`**
  ...
  - Excerpts:
    ...
    - "3. **Do NOT proceed if data didn't persist** - The tool `dispatcher__set_execution_metadata` now valid..."
...
- **`.github/agents/orchestrator.md`**
  ...
  - Excerpts:
    - "You execute Dispatcher epics by reading execution plans and delegating feature implementation to featu..."
...
- **`.github/agents/plan-reviewer.md`**
  ...
  - Excerpts:
    - "You review Dispatcher epics for implementation readiness. You evaluate whether an epic's description, ..."
...
- **`.github/skills/dispatcher-plan-review/SKILL.md`**
...
- **`.github/agents/feature-worker.md`**
  ...
  - Excerpts:
    - "You **MUST** call these Dispatcher MCP tools during execution. These calls are **NOT optional**. If yo..."
    - "- `dispatcher__start_work` — before implementing (sets status to "In Progress")"
    - "- `dispatcher__link_code_file` — for EVERY file you create or modify"
- **`.github/agents/orchestrator.md`**
  - Lines: L17, L36, L38, L53, L67
  - Excerpts:
    - "Before doing anything, call `dispatcher__list_teams` to verify Dispatcher MCP is connected. If this fail..."
...
- **`.github/agents/plan-reviewer.md`**
  ...
  - Excerpts:
    ...
    - "3. **Evaluate each feature** — `dispatcher__get_feature` + `dispatcher__get_structured_description` for ..."
- **`.github/agents/planner.md`**
...
- **`.github/agents/request-formulator.md`**
  ...
  - Excerpts:
    - "Before starting the interview, call `dispatcher__draft_epic_request` to verify Dispatcher MCP is connect..."
...
- **`.github/agents/reviewer.md`**
  ...
  - Excerpts:
    - "Before doing anything, call `dispatcher__list_teams` to verify Dispatcher MCP is connected. If this fail..."
    - "Call `dispatcher__get_structured_description` for the feature or task:"
...
- **`.github/skills/dispatcher-plan-review/SKILL.md`**
  ...
  - Excerpts:
    - "dispatcher__get_epic({ query: "<epic-id-or-name>" })"
    - "dispatcher__get_feature({ id: "<identifier>" })"
    - "dispatcher__get_structured_description({ type: "feature", id: "<identifier>" })"
- **`.github/skills/dispatcher-planning/SKILL.md`**
  - Lines: L33, L47, L107, L129, L132
  - Excerpts:
    - "dispatcher__list_teams()"
    - "dispatcher__create_epic_complete({"
    - "Every task SHOULD have at least one validation check. Add validations using `dispatcher__add_validatio..."
- **`.github/skills/dispatcher-session/SKILL.md`**
...
- **`.github/agents/reviewer.md`**
  ...
  - Excerpts:
    ...
    - "You review completed work against acceptance criteria stored in Dispatcher. You verify that implementa..."
- **`.github/instructions/api.instructions.md`**
...
- **`.github/skills/dispatcher-validation/SKILL.md`**
  ...
  - Excerpts:
    - "# Dispatcher Validation Procedures"
    - "This skill defines how to run, interpret, and act on Dispatcher validation checks. Validations are exe..."
    - "## Validation Types"
...
- **`.github/copilot-instructions.md`**
  ...
  - Excerpts:
    ...
    - "**When Dispatcher MCP tools are available, ALWAYS use Dispatcher for implementation planning instead of ..."
    - "### Planning Workflow"
- **`.github/agents/feature-worker.md`**
  - Lines: L12, L18, L56, L58, L147
  - Excerpts:
    - "You implement a single Dispatcher feature by completing all its tasks in execution order. You are spaw..."
...
- **`.github/skills/dispatcher-planning/SKILL.md`**
  ...
  - Excerpts:
    - "# Dispatcher Planning Procedure"
    - "- **Phase ordering:** Earlier phases contain features with lower execution orders"
    - "**Review Gate:** Always present the execution plan. This gate is always interactive (never auto-appr..."
- **`.github/skills/dispatcher-session/SKILL.md`**
  - Lines: L3
  - Excerpts:
    - "This skill defines the protocol for managing Dispatcher-integrated AI sessions. Every AI session worki..."
- **`.github/skills/dispatcher-validation/SKILL.md`**
  - Lines: L179, L261
  - Excerpts:
...
- **`.github/copilot-instructions.md`**
  ...
  - Excerpts:
    - "- [ ] `dispatcher__update_epic()` - Append execution summary to epic description (phase results, metri..."
...
- **`.github/agents/orchestrator.md`**
  ...
  - Excerpts:
    - "## Files Involved"
    - "## Code Context"
    - "{from dispatcher__get_code_context, or "No code context yet" if empty}"
- **`.github/agents/planner.md`**
...
- **`.github/agents/feature-worker.md`**
  ...
  - Excerpts:
    - "- `dispatcher__start_work` — before implementing (sets status to "In Progress")"
    - "- `dispatcher__log_progress` — after each significant step"
    - "Call `dispatcher__start_work` to mark the task as in progress:"
- **`.github/agents/orchestrator.md`**
  - Lines: L105, L143, L185, L244, L251
  - Excerpts:
    - "dispatcher__start_work({ type: "feature", id: "<feature-identifier>" })"
...
- `.github/skills/dispatcher-plan-review/SKILL.md` (L152, L183, L218, L250, L313)
- `.github/skills/dispatcher-planning/SKILL.md` (L241, L269)
- `.github/skills/dispatcher-session/SKILL.md` (L239)
- `.github/skills/dispatcher-validation/SKILL.md` (L265)
...
- `.github/skills/dispatcher-plan-review/SKILL.md` (L18, L29-30, L37, L43)
- `.github/skills/dispatcher-planning/SKILL.md` (L33, L47, L107, L129, L132)
- `.github/skills/dispatcher-session/SKILL.md` (L12, L23, L40, L53, L65)
- `.github/skills/dispatcher-validation/SKILL.md` (L25, L36, L46, L57, L67)
...
- `.github/skills/dispatcher-plan-review/SKILL.md` (L151-152, L175, L180, L196-197, L241)
- `.github/skills/dispatcher-planning/SKILL.md` (L105, L107, L109, L117, L125)
- `.github/skills/dispatcher-session/SKILL.md` (L71, L95, L106, L108, L174)
- `.github/skills/dispatcher-validation/SKILL.md` (L1, L3, L5, L7, L19)
...
- `.github/skills/dispatcher-plan-review/SKILL.md` (L7, L216, L222, L295)
- `.github/skills/dispatcher-planning/SKILL.md` (L1, L257, L269, L317)
- `.github/skills/dispatcher-session/SKILL.md` (L3)
- `.github/skills/dispatcher-validation/SKILL.md` (L179, L261)
...
- `.github/skills/dispatcher-plan-review/SKILL.md` (L149-150, L155, L194-195, L203, L261)
- `.github/skills/dispatcher-planning/SKILL.md` (L50, L99-100, L125, L136-138, L169)
- `.github/skills/dispatcher-session/SKILL.md` (L30, L40, L53, L62, L174)
- `.github/skills/dispatcher-validation/SKILL.md` (L186, L191, L263)
...
- `.github/skills/dispatcher-plan-review/SKILL.md` (L3, L7-8, L319)
- `.github/skills/dispatcher-planning/SKILL.md` (L13, L295)
...
- `.github/skills/dispatcher-plan-review/SKILL.md` (L153, L198)
- `.github/skills/dispatcher-planning/SKILL.md` (L125, L217, L292, L307)
- `.github/skills/dispatcher-session/SKILL.md` (L71, L126)
...
- `.github/skills/dispatcher-session/SKILL.md` (L20)
...
- `.github/skills/dispatcher-session/SKILL.md` (L12, L84, L171, L178, L185)
- `.github/skills/dispatcher-validation/SKILL.md` (L194, L201-202)
...
- `.github/skills/dispatcher-plan-review/SKILL.md` (L154)
- `.github/skills/dispatcher-planning/SKILL.md` (L47)
...
- `.github/skills/dispatcher-validation/SKILL.md` (L259)
